About publish-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/publish-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=827&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/publish-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `publish` can be installed with `conda`:
...
```
mamba install publish
```

It is possible to list all of the versions of `publish` available on your platform with `conda`:
...
```
mamba search publish --channel conda-forge
```
...
mamba repoquery search publish --channel conda-forge

# List packages depending on `publish`:
mamba repoquery whoneeds publish --channel conda-forge

# List dependencies of `publish`:
mamba repoquery depends publish --channel conda-forge
```
